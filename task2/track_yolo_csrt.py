...
if __name__ == '__main__':
    ...
    parser.add_argument('--output-video', nargs='+', type=str, default='ball_tracking_csrt_yolo.mp4', help='output video path')
    parser.add_argument('--output-csv', nargs='+', type=str, default='video_frames_csrt.csv',help='output csv')
